...
private:
    const std::array<std::array<EdgeMeshes, 2>, kNumEdges> edge_mesh_ = {{
       ...
       {{  {{1.0, 1.0, 1.0, 1.0}, { 0.2, -0.6,  0.2,
        ...
        {{ {{1.0, 1.0, 0.0, 1.0}, { 0.6,  0.6,  0.2,
                                    0.6,  0.6, -0.2,
                                    0.2,  0.6, -0.2,
                                    0.2,  0.6,  0.2}, {0, 1, 3,
                                                       1, 2, 3}},     // yellow
           {{0.0, 0.0, 1.0, 1.0}, { 0.6,  0.6,  0.2,
                                    0.6,  0.6, -0.2,
                                    0.6,  0.2, -0.2,
                                    0.6,  0.2,  0.2}, {0, 1, 3,
                                                       1, 2, 3}} }},  // blue

        {{ {{1.0, 1.0, 1.0, 1.0}, { 0.6, -0.6,  0.2,
                                    0.6, -0.6, -0.2,
                                    0.2, -0.6, -0.2,
                                    0.2, -0.6,  0.2}, {0, 1, 3,
                                                       1, 2, 3}},     // white
